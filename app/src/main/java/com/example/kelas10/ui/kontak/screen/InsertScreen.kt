package com.example.kelas10.ui.kontak.screen
...
import com.example.kelas10.ui.kontak.viewmodel.InsertUiEvent
import com.example.kelas10.ui.kontak.viewmodel.InsertUiState
...
fun EntryKontakScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBarKontak(title = DestinasiEntry.titleRes,
